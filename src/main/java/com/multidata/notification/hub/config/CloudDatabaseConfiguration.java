package com.multidata.notification.hub.config;
...
@Configuration
@EnableMongoRepositories("com.multidata.notification.hub.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.multidata.notification.hub.config.dbmigrations");
