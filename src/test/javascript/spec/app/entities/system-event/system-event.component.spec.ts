...
import { SystemEventComponent } from 'app/entities/system-event/system-event.component';
...
describe('Component Tests', () => {
    describe('SystemEvent Management Component', () => {
        let comp: SystemEventComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SystemEventComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.systemEvents[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
